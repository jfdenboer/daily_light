...
THUMBNAIL_TEXT_STROKE_WIDTH_RATIO = 0.004
THUMBNAIL_TEXT_STROKE_MIN_WIDTH = 0

THUMBNAIL_TEXT_SHADOW_X_OFFSET_RATIO = 0.0
THUMBNAIL_TEXT_SHADOW_X_MIN_OFFSET = 0
THUMBNAIL_TEXT_SHADOW_Y_OFFSET_RATIO = 0.0
THUMBNAIL_TEXT_SHADOW_Y_MIN_OFFSET = 0
THUMBNAIL_TEXT_SHADOW_ALPHA = 0
...
def shadow_offset_for_font_size(font_size: int) -> tuple[int, int]:
    x_offset = max(
        THUMBNAIL_TEXT_SHADOW_X_MIN_OFFSET,
        round(font_size * THUMBNAIL_TEXT_SHADOW_X_OFFSET_RATIO),
    )
    y_offset = max(
        THUMBNAIL_TEXT_SHADOW_Y_MIN_OFFSET,
        round(font_size * THUMBNAIL_TEXT_SHADOW_Y_OFFSET_RATIO),
    )
