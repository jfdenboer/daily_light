...
class VideoCompiler:
    ...
    def build_reading_card_filters(self, reading_start: float) -> str:
        ...
        shadow_box = (
            "drawbox="
            f"x=(iw-iw*{width_ratio:.4f})/2+{shadow_offset}:"
            f"y=(ih-ih*{height_ratio:.4f})/2+{shadow_offset}:"
            f"w=iw*{width_ratio:.4f}:"
            f"h=ih*{height_ratio:.4f}:"
        ...
        main_box = (
            "drawbox="
            f"x=(iw-iw*{width_ratio:.4f})/2:"
            f"y=(ih-ih*{height_ratio:.4f})/2:"
            f"w=iw*{width_ratio:.4f}:"
            f"h=ih*{height_ratio:.4f}:"
